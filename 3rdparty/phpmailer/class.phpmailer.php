<?php
/**
 * PHPMailer - PHP email creation and transport class. For Comunic
 * PHP Version 5
 * @package PHPMailer
...
class PHPMailer
{
    ...
    public static function validateAddress($address, $patternselect = 'auto')
    {
		...
		//On vérifie si une vérification de l'adresse mail est nécessaire ou pas
		if($mode_site != "offline")
		{
		...
		{
			return true; //Mode hors-ligne : pas de vérification
		}
    }
